...
import entity.exercise3.Phone;
import entity.exercise3.Staff;
...
public class Generic {
	...
	public void question1_2_3() {
		...
		Student<Integer> student1 = new Student<Integer>(1, "Khong Van");

		// khởi tạo student có id là float
		Student<Float> student2 = new Student<Float>(2.0f, "Khong Thi Van");
